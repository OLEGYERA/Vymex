<template>
  <div class="resources-editing-resource-view">
    <comeback @onClick="$router.push({name: 'resources.resource.info'})"/>
    <title-base>Редактирование ресурса</title-base>
    <div class="main-plate">
      <div>djjdjdj</div>
      <input-base :placeholder="'Название'" :model="object.name"></input-base>
      <input-base :placeholder="'Серийный номер'" :model="object.number"/>
...
.resources-editing-resource-view {
  height: 100%;
  width: 100%;
  padding: 24px 0;
