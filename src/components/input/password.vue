<template>
  <div class="input-password" :class="{error: errorAfterBlur, success: tooltipSuccess, disable: disable}">
    <input-base
      :input-model="InputModel"
      :placeholder="placeholder"
      :type="showPasswordStatus ? 'text' : 'password'"
      :input-focus="innerToggle"
      :disable="disable"
      @onBlur="handleBlur"
      @onInput="handleInputPassword"
    />
    <icon-eye @click.native="showPassword" v-if="!showPasswordStatus"/>
